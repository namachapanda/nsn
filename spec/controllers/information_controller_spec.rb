...
describe InformationController do
  ...
  let(:valid_attributes) { { "info" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved information as @information" do
        ...
        post :create, {:information => { "info" => "invalid value" }}, valid_session
        assigns(:information).should be_a_new(Information)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested information" do
        ...
        Information.any_instance.should_receive(:update_attributes).with({ "info" => "MyString" })
        put :update, {:id => information.to_param, :information => { "info" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the information as @information" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Information.any_instance.stub(:save).and_return(false)
        put :update, {:id => information.to_param, :information => { "info" => "invalid value" }}, valid_session
        assigns(:information).should eq(information)
      end
