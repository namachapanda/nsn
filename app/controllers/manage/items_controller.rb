...
class Manage::ItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @item.save
        format.html { redirect_to manage_items_path, notice: 'Item was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @item.update_attributes(params[:item])
        format.html { redirect_to manage_items_path, notice: 'Item was successfully updated.' }
